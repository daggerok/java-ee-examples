<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:template match="Items">
    ...
    <xsl:for-each select="Item">INSERT INTO ITEM (id, version, discriminator, title, nb_of_discs, rank, small_image_url,
      medium_image_url, language, unit_cost, publication_date, genre_id, label_id, description) VALUES (
